...
import os
import sys
WS_PATH = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))


sys.path.insert(0, WS_PATH)
sys.path.insert(0, os.path.join(WS_PATH, "rsl_rl"))
sys.path.insert(0, os.path.join(WS_PATH, "source/unitree_rl_lab"))
